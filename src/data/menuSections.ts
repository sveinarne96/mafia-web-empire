...
export const LEFT_MENU_SECTIONS = [
  ...
  { title: "New Frontiers", icon: Crown, items: [
    { label: "Login Streak & Bonuses", page: "streak_rewards", icon: "📅" },
    { label: "Milestones & Badges", page: "milestones", icon: "🏅" },
    { label: "Player of the Week & Fame", page: "player_of_week", icon: "🏆" },
    { label: "VIP Lounge", page: "vip_lounge", icon: "👑" },
    { label: "Flash Deals & Events", page: "flash_deals", icon: "⚡" },
    { label: "Lottery Jackpot", page: "lottery_rollover", icon: "🎫" },
    { label: "Boss Invasion", page: "boss_invasion", icon: "🐉" },
    { label: "Bug Bounty & Ideas", page: "bug_bounty", icon: "🐛" },
    { label: "Economy Heat-Map", page: "economy_heatmap", icon: "📊" },
  ]},
  { title: "Frontier Economy", icon: Wallet, items: [
    { label: "Business Empire", page: "business_empire", icon: "🏢" },
    { label: "Property Flipping", page: "property_flip", icon: "🏘️" },
