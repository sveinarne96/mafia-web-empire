...
export const LEFT_MENU_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Underground Arena", page: "arsenal_arena", icon: "🥊" },
      { label: "Street Trainer", page: "arsenal_trainer", icon: "🥋" },
      { label: "Gun Range", page: "arsenal_range", icon: "🎯" },
      { label: "Race Stakes", page: "arsenal_race", icon: "🏁" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Bodyguards", page: "bodyguards", icon: "🛡️" },
      { label: "Safehouse Hotel", page: "arsenal_hotel", icon: "🏨" },
      { label: "Tipsy Informant", page: "arsenal_informant", icon: "🍺" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Dockworker Hustle", page: "x_dock", icon: "⚓" },
      { label: "Chop-Shop Parts", page: "x_chop", icon: "🔧" },
      { label: "Graffiti Crew", page: "x_graffiti", icon: "🎨" },
      { label: "Pawn Shop Flips", page: "x_pawn", icon: "🏗️" },
      { label: "Cab Company", page: "x_cab", icon: "🚕" },
      { label: "Junkyard Dogs", page: "x_dogs", icon: "🐕" },
      { label: "Night Market", page: "x_nightmarket", icon: "🏮" },
      { label: "Cable Piracy", page: "x_cable", icon: "📺" },
      { label: "Numbers Racket", page: "x_numbers", icon: "🎱" },
      { label: "Valet Hustle", page: "x_valet", icon: "🅿️" },
      { label: "Bathhouse", page: "x_bath", icon: "♨️" },
      { label: "Billboards", page: "x_billboards", icon: "🌆" },
    ],
  },
  {
    title: "Special",
