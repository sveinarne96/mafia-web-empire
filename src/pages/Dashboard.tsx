...
const renderPage = () => {
    ...
    switch (activePage) {
      ...
      case "economy": return <HubPage title="Economy Hub" icon="💰" tabs={[
      ...
      case "assets": return <HubPage title="Assets Hub" icon="📦" tabs={[
      ...
      case "social": return <HubPage title="Social Hub" icon="🤝" tabs={[
      ...
      case "progression": return <HubPage title="Progression Hub" icon="🧠" tabs={[
      ...
      case "special": return <HubPage title="Special Hub" icon="👻" tabs={[
      ...
      case "forums": return <HubPage title="Forums Hub" icon="📢" tabs={[
      ...
      case "chats": return <HubPage title="Chats Hub" icon="💬" tabs={[
      ...
      case "quickinfo": return <HubPage title="Quick Info Hub" icon="🗺️" tabs={[
      ...
      case "seasonal": return <HubPage title="Seasonal Events Hub" icon="🎆" tabs={[
      ...
      case "server_events": return <HubPage title="Server Events" icon="⚡" tabs={[
      ...
      case "help": return <HubPage title="Help Center" icon="❓" tabs={[
