      ...
      <div className="p-3 border-b border-sidebar-border">
        ...
        {player ? (
          <div className="space-y-2">
            ...
            <div>
              <div className="flex justify-between text-[11px] font-semibold text-sidebar-foreground/70 mb-1"><span>Life</span><span>{life}/{maxLife}</span></div>
              <div className="h-3.5 rounded-full bg-sidebar-accent overflow-hidden border border-red-500/20">
                <div className="h-full rounded-full bg-gradient-to-r from-red-600 to-red-400" style={{ width: `${(life / maxLife) * 100}%` }} />
              </div>
            </div>
            <div>
              <div className="flex justify-between text-[11px] font-semibold text-sidebar-foreground/70 mb-1"><span>XP</span><span>Lv. {level}</span></div>
              <div className="h-3.5 rounded-full bg-sidebar-accent overflow-hidden border border-yellow-500/20">
                <div className="h-full rounded-full bg-gradient-to-r from-yellow-600 to-yellow-400" style={{ width: `${xpPct}%` }} />
              </div>
            </div>
            <div className="flex items-center justify-between bg-gradient-to-r from-green-900/30 to-emerald-900/20 border border-green-500/20 rounded-lg px-2.5 py-1.5">
              <span className="text-[11px] font-semibold text-green-300/80">💰 Cash</span>
              <span className="text-[11px] font-bold text-green-300">${money.toLocaleString()}</span>
            </div>
          </div>
