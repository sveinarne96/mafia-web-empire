...
export function StreetCrimesPage() {
  ...
  return (
    <div className="animate-fade-in space-y-5">
      ...
      <section className="greenhouse-command overflow-hidden rounded-2xl border border-emerald-500/25 bg-gradient-to-br from-emerald-950/25 via-slate-950/90 to-green-950/20 shadow-xl shadow-black/20">
        <div className="border-b border-emerald-500/15 p-4"><div className="flex items-center gap-3"><div className="flex size-10 items-center justify-center rounded-xl border border-emerald-400/30 bg-emerald-400/10"><Sprout className="size-5 text-emerald-300" /></div><div><div className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-300">Business expansion · production network</div><h2 className="text-xl font-black text-white">Greenhouse <span className="text-emerald-300/70">/ grow room</span></h2><p className="text-[10px] text-slate-400">Turn demand into inventory, inventory into shipments, and shipments into a reputation the city remembers.</p></div>{hasGreenhouse && <span className="ml-auto rounded-full border border-emerald-400/25 bg-emerald-400/10 px-2 py-1 text-[9px] font-bold text-emerald-300">ACTIVE</span>}</div></div>
